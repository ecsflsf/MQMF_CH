...
```{r fig.cap="An example series of histograms using data from the MQMF data set LatA, illustrating how one can iterate towards a final plot. See also the function uphist()."}
...
knitr::kable(ans,longtable = TRUE, booktabs= TRUE, digits = 2, 
             caption = "Three different ways of generating the same growth curve")
...
```{r fig.cap="The catch and cpue data from the MQMF data-set schaef plotted automatically."}
